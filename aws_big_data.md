...
- [] They are a means to extract data from a source, transform the data in some way, and load it toa target.
...
#### 11. Shiraz has been working with an S3 data lake and Amazon Glue for a big data
- [] application a client in finance. He is setting up a new database with new
- [] partitions and tables that ingests historical stock data. When performing a
- [] new query, he receives a HIve_PARTITION_SCHEMA_MIsmATcH error. Why is this
...
#### 17. Melanie is configuring a JDBC client to connect with her Amazon Redshift
- [] cluster. After she finishes provisioning the connection, she sets her initial call
- [] request. When the request comes back, it is providing a client-side-out-of-
- [] memory error instead of the query results. Generally speaking, why is this
